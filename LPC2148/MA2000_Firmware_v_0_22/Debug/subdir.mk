...
%.o: ../%.S
	...
	arm-none-eabi-gcc -x assembler-with-cpp -I"C:\Dropbox\ARM\PROGRAMAS\LPC2148\MA2000_Firmware_v_0_22" -Wall -Wa,-adhlns="$@.lst" -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -mcpu=arm7tdmi -g3 -gdwarf-2 -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
